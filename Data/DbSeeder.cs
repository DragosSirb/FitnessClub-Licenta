...
namespace FitnessClub.Data
{
    public static class DbSeeder
    {
        ...
        private static async Task SeedTrainers(UserManager<ApplicationUser> userManager, AppDbContext context)
        {
            ...
            {
                new { Email = "ion.popescu@fitnessclub.ro",    First = "Ion",    Last = "Popescu",   Expertise = "Fitness & Forță",               Desc = "Specialist în antrenamente de forță și hipertrofie cu peste 8 ani experiență. Lucrează cu sportivi de toate nivelurile.", Years = 8,  Days = new[] { DayOfWeek.Monday, DayOfWeek.Wednesday, DayOfWeek.Friday } },
                new { Email = "maria.ionescu@fitnessclub.ro",  First = "Maria",  Last = "Ionescu",   Expertise = "Yoga & Pilates",                 Desc = "Instructor certificat de yoga și pilates, pasionată de echilibrul minte-corp și recuperare activă.",                    Years = 5,  Days = new[] { DayOfWeek.Tuesday, DayOfWeek.Thursday, DayOfWeek.Saturday } },
                new { Email = "alex.dumitru@fitnessclub.ro",   First = "Alex",   Last = "Dumitru",   Expertise = "Cardio & HIIT",                  Desc = "Antrenor specializat în antrenamente cardio de intensitate ridicată și programe de slăbire.",                           Years = 6,  Days = new[] { DayOfWeek.Monday, DayOfWeek.Wednesday, DayOfWeek.Friday } },
                new { Email = "ioana.constantin@fitnessclub.ro", First = "Ioana", Last = "Constantin", Expertise = "Zumba & Dans Fitness",          Desc = "Instructor de dans fitness și zumba cu energie contagioasă. Clasele ei sunt mereu pline de entuziasm și muzică bună.", Years = 4,  Days = new[] { DayOfWeek.Tuesday, DayOfWeek.Thursday, DayOfWeek.Saturday } },
                new { Email = "radu.marian@fitnessclub.ro",    First = "Radu",   Last = "Marian",    Expertise = "CrossFit & Antrenament Funcțional", Desc = "Antrenor CrossFit certificat Level 2. Specializat în mișcări funcționale, mobilitate și condiție fizică generală.",  Years = 7,  Days = new[] { DayOfWeek.Monday, DayOfWeek.Tuesday, DayOfWeek.Thursday } }
            };
        ...
        private static async Task SeedPlans(AppDbContext context)
        {
            var plans = new[]
            {
                ...
                new SubscriptionPlan
                {
                    ...
                    Price = 1499,
                    DurationDays = 365,
                    Description = "Abonament pe 12 luni cu acces nelimitat și clase de grup incluse. Economisești echivalentul a 3 luni.",
                    IncludesGroupClasses = true,
                    IsActive = true,
                    Type = SubscriptionPlanType.Subscription
                },
                new SubscriptionPlan
                {
                    ...
                    Price = 25,
                    DurationDays = 1,
                    Description = "Acces pentru o singură zi. Perfect dacă ești în trecere sau vrei să testezi sala.",
                    IncludesGroupClasses = false,
                    IsActive = true,
                    Type = SubscriptionPlanType.DayPass
                },
                new SubscriptionPlan
                {
                    Name = "Student Basic",
        ...
        private static async Task SeedShop(AppDbContext context)
        {
            ...
            {
                { "Whey Protein 1kg",              "/images/shop/Whey_Protein_1kg.jpg" },
                { "Pre-Workout Energizant",         "/images/shop/Whey_Protein.jpg" },
                { "BCAA 300g",                     "/images/shop/BCAA_300g.jpg" },
                { "Creatină Monohidrat 500g",       "/images/shop/Creatina_Monohidrat_500g.jpg" },
                { "Batoane Proteice (12 buc)",      "/images/shop/Batoane_Proteice_12buc.jpg" },
                { "Omega-3 Fish Oil 90 caps",       "/images/shop/BCAA_300g.jpg" },
                { "Multivitamine Sport 60 tabs",    "/images/shop/Creatina_Monohidrat.jpg" },
                { "Mănuși Fitness",                 "/images/shop/Manusi_Fitness.jpg" },
                { "Set Benzi Elastice (3 nivele)",  "/images/shop/Coarda_de_Sarit.jpg" },
                { "Coarda de Sărit",                "/images/shop/Coarda_de_Sarit.jpg" },
                { "Foam Roller Pro",                "/images/shop/Foam_Roller_Pro.jpg" },
                { "Set Gantere Reglabile 2×10kg",   "/images/shop/Foam_Roller_Pro.jpg" },
                { "Bidon Sport BPA-Free 750ml",     "/images/shop/Bidon_Sport_BPA-Free_750ml.jpg" },
                { "Geantă Sport 40L",               "/images/shop/Geanta_Sport_40L.jpg" },
                { "Shaker Proteic 700ml",           "/images/shop/Shaker_Proteic_700ml.jpg" },
                { "Saltea Yoga 183×61cm",           "/images/shop/Leggings_Sport_Femei.jpg" },
                { "Tricou Fitness Dry-Fit",         "/images/shop/Tricou_Fitness_Dry-Fit.jpg" },
                { "Leggings Sport Femei",           "/images/shop/Leggings_Sport_Femei.jpg" },
                { "Shorts Antrenament Bărbați",     "/images/shop/Shorts_Antrenament_Barbati.jpg" },
                { "Top Sport Femei",                "/images/shop/Top_Sport_Femei.jpg" },
                { "Hanorac Oversize Unisex",        "/images/shop/Hanorac_Oversize_Unisex.jpg" },
                { "Jambiere Compresie Bărbați",     "/images/shop/Jambiere_Compresie_Barbati.jpg" },
            };
