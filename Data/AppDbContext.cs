    ...
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Quote>().HasData(
                new Quote { Id = 1, Text = "Singurul antrenament prost este cel care nu a avut loc.", Author = "Unknown", IsActive = true },
                new Quote { Id = 2, Text = "Progres, nu perfecțiune.", Author = "Unknown", IsActive = true },
                new Quote { Id = 3, Text = "Împinge-te tu însuți, pentru că nimeni altcineva nu o va face pentru tine.", Author = "Unknown", IsActive = true },
                new Quote { Id = 4, Text = "Succesul începe cu autodisciplina.", Author = "Unknown", IsActive = true },
                new Quote { Id = 5, Text = "Corpul tău poate suporta aproape orice. Mintea ta este cea pe care trebuie să o convingi.", Author = "Unknown", IsActive = true }
            );
        }
    }
}
