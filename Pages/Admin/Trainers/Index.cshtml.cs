...
namespace FitnessClub.Pages.Admin.Trainers
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostCreateAsync()
        {
            ...
            var tempPassword = $"Trainer@{Input.FirstName}123.";
            ...
            TempData["Success"] = $"Cont antrenor creat. Parolă temporară: {tempPassword} (trimite antrenorului pentru a-și seta propria parolă la prima autentificare).";
