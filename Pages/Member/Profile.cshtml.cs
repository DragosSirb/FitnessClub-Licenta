...
namespace FitnessClub.Pages.Member
{
    ...
    public class ProfileModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            TempData["Success"] = "Profil actualizat cu succes!";
        ...
        public async Task<IActionResult> OnPostChangePasswordAsync()
        {
            ...
            {
                TempData["PasswordError"] = "Completează toate câmpurile pentru parolă și asigură-te că se potrivesc.";
                return RedirectToPage();
            }

            var result = await _userManager.ChangePasswordAsync(user, PasswordInput.CurrentPassword, PasswordInput.NewPassword);
            if (result.Succeeded)
                TempData["PasswordSuccess"] = "Parola a fost schimbată cu succes!";
            else
