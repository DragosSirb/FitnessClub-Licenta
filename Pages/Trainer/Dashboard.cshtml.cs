        ...
        public async Task<IActionResult> OnPostConfirmAsync(int sessionId)
        {
            ...
            if (member != null)
            {
                _context.Notifications.Add(new Notification
                {
                    ...
                    Message = $"Your session on {session.Date:dd MMM yyyy} at {session.StartTime} has been confirmed.",
        ...
        public async Task<IActionResult> OnPostDeclineAsync(int sessionId)
        {
            ...
            if (member != null)
            {
                _context.Notifications.Add(new Notification
                {
                    ...
                    Message = $"Your session on {session.Date:dd MMM yyyy} at {session.StartTime} was declined by the trainer.",
                    Type = NotificationType.Session,
